 ...
 * Считается что пользователь которому исполнилось 7 (значение по-умолчанию) лет - это верно указанная дата рождения в профиле пользователя.
 * Другие количества лет (меньше данного значения, 0 - 6 лет) не будут учитываться и будут отброшены как некорректные
