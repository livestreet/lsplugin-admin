...
return array(
	...
	'utils' => array(
		...
		'reset_n_clear' => array(
			...
			'datareset' => array(
				...
				'resetalllscache' => 'Сбросить весь кеш движка (данные, компилированные шаблоны, сжатые CSS и JS файлы)',
			),
		),
	...
	'config_parameters' => array(
		 ...
		 */
		'bans' => array(
			'auto_delete_old_ban_records' => array(
				'name' => 'Авточистка банов',
				'description' => 'Автоматически удалять старые записи банов если дата окончания бана уже прошла',
			),
			'gather_bans_running_stats' => array(
				'name' => 'Статистика для банов',
				'description' => 'Собирать статистку по срабатываниям банов',
			),
		),
		/*
	...
	'config_sections' => array(
		 ...
		 */
		'sandbox' => array(
			'title' => 'Песочница (тестовые настройки)',
		),
		/*
		 * раздел "баны"
		 */
