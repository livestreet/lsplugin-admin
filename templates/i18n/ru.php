...
return array(
	...
	'index' => array(
		...
		'topics' => 'топиков',
		'blogs' => 'блогов',
		'new_users_for_week' => 'новых пользователей по сравнению с прошлой неделей',
		...
		'new_topics_info' => 'новых топиков по сравнению с прошлым аналогичным периодом',
		'new_comments_info' => 'новых комментариев по сравнению с прошлым аналогичным периодом',
		'new_blogs_info' => 'новых блогов по сравнению с прошлым аналогичным периодом',
		'new_users_info' => 'новых пользователей по сравнению с прошлым аналогичным периодом',
