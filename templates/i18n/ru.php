...
return array(
	...
	'errors' => array(
		...
		'encoding_check' => array(
			...
			'utf8_bom_encoding_detected' => 'В файле <b>%%file%%</b> найдена некорректная кодировка utf-8 BOM,
			которая может вызывать разные проблемы при работе с движком, нужно открыть указанный файл и изменить кодировку на "utf-8 БЕЗ BOM"',
		),
