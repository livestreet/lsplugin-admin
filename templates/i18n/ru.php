...
return array(
	...
	'errors' => array(
		...
		'tickets' => array(
			 ...
			 */
			'claims' => array(
				'wrong_user_id' => 'Пользователь не найден',
			),
		),
...
/*			'addon_type' => array(
	...
	'tickets' => array(
		 ...
		 */
		'claims' => array(
			'add_link_text' => 'Пожаловаться на пользователя...',
			/*
			 * страница добавления жалобы
			 */
			'add' => array(
				'title' => 'Отправить жалобу на пользователя',
				/*
				 * типы жалоб
				 */
				'types' => array(
				 ...
				 * текст подсказки
				 */
				'text_ph' => 'Укажите дополнительную информацию, которая поможет в расследовании, например, ссылки на факты',
				/*
				 * подписи кнопок
				 */
				'buttons' => array(
