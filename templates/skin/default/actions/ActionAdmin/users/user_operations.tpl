...
*}
{if !in_array($oUser->getId(), $oConfig->GetValue('plugin.admin.block_managing_admin_rights_user_ids'))}
...
*}
{if !in_array($oUser->getId(), $oConfig->GetValue('plugin.admin.block_deleting_user_ids'))}
