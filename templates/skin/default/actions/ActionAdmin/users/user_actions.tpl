...
{if !in_array($oUser->getId(), $oConfig->Get('plugin.admin.users.block_managing_admin_rights_user_ids'))}
...
{if !in_array($oUser->getId(), $oConfig->Get('plugin.admin.users.block_deleting_user_ids'))}
