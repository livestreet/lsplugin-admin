	...
	{*
		...
		Входящие переменные:
			...
			$sObjectsType - тип объектов, которые нужно показать (topics, comments etc)
			$sDataType - тип данных, которые нужно показать (votings, ratings)
			$sGraphLineTitle - тайтл для линии голосов и рейтингов
			
			$aDataGrowth - весь массив с данными
	*}
