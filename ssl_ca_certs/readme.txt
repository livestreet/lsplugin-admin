...
Эта сборка центров корневых сертификатов (cA) X.509 взята с открытого источника - mozilla.org, которая распостряняется вместе с библиотекой CURL по адресу:
