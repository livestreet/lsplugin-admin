...
{component 'admin:field.checkbox' name='validate[access_only_auth]' checked=$propertyParams.access_only_auth label='Доступ к файлу только для авторизованных пользователей'}
